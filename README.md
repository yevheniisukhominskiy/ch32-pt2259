...
Бібліотека для управління аудіопроцесором PT2259 (8-pin, 2-канальний регулятор гучності) для мікроконтролерів CH32. Чіп використовує технологію CMOS, має діапазон затухання від 0 до -79 дБ, низький рівень шуму та високий ступінь розділення стереоканалів. Підтримує як апаратний (Hardware), так і програмний (Software) I2C.
